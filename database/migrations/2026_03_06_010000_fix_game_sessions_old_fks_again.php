...
/**
 * The art_prompts_status migration recreated game_sessions via rename/copy/drop,
 * which left encounters, scene_art_prompts, session_events, inventory_snapshots,
 * and speaker_profiles with FKs still pointing at "game_sessions_old".
 * This migration rebuilds each of those tables with the correct FK target.
 */
return new class extends Migration
{
    ...
    {
        // No meaningful rollback — data is preserved, only FK target string changes
    }
};
